...
const News =(props)=>{
   ...
   const [totalResults,setTotalResults]=useState(0)
    ...
    const  updateNews=async()=> {
        ...
        const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=a02e2e109f4748b884c804c6337534ba&page=${page}&pageSize=${props.pageSize}`;
        setLoading(true)
    ...
    const fetchMoreData = async () => {
        ...
        const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=a02e2e109f4748b884c804c6337534ba&page=${page+1}&pageSize=${props.pageSize}`;
        setPage(page+1)
        let data = await fetch(url);
        let parsedData = await data.json();
